...
let text1 = "Wir landen auf dem Planeten des Mediendesigns. Hier kannst du die Stationen \"Typografie\", \"Farben\" und \"Formen\" besuchen.";
...
document.addEventListener('DOMContentLoaded', function() {
    if (!localStorage.getItem('md_visited')) {
