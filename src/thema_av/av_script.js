...
const levels = ["Licht", "Kamera", "Audio", "Editing"];
let currentLevel = 0;
let text1 = "Wir landen auf dem Planeten der Audiovisuellen Medien. Hier kannst du die Stationen \"Licht\", \"Kamera\", \"Audio\" und \"Editing\" besuchen.";
...
let start = 0;
let breakpointLevel = [0.14, 0.36, 0.57, 0.78];
...
document.addEventListener('DOMContentLoaded', function() {
    if (!localStorage.getItem('av_visited')) {
